...
#           t(n)     theta values
# MODIFIES:  ---
# EFFECT:   returns the sigmoid function
#           used in classification problems
##
function S = sigmoid(X, t)
clear functions
  ...
  for i=1:m,
    for j = 1:n,
      z(i) += t(j) * X(i,j);    # hypothesis of x
    end;
  end;
  
  gz = 1 ./ (1 + e.^-z);        # predictions
  S = gz;
...
##
# REQUIRES: X(m * n) containing the training examples
#           y(n)     dataset values (y = 0 or 1)
#           t(n)     theta values
# MODIFIES:  ---
# EFFECT:   returns the logistic cost function J(theta)
#           J=-(1/m)*sum(y'*log(H)+(1-y)'*log(1-H));
##
function J = logisticCost(X,y,t)
clear functions
...
#           t(n)     theta values
# MODIFIES:  ---
# EFFECT:   returns the minimized cost function J(theta)
#           using logistic cost function and sigmoid function
##
function L = logisticRegression(x,y,t,alpha,feedback)
clear functions

# =================================
# INNER HYPOTHESIS SIGMOID FUNCTION
# =================================
  function S = sigmoid(X, t)
  clear functions
...
# ==============================
  ...
  while true,
    ...
    J = logisticCost(x,y,t);                   # cost of x
    ...
    Jm = logisticCost(x,y,t);                  # new cost of x
